...
| `docs/.vitepress/theme/`                                                                   | The default theme plus the Mixpanel palette (`mixpanel.css`, ported from the Python site) and the copy-as-Markdown buttons above every page. Plain TypeScript, no Vue SFC. |
