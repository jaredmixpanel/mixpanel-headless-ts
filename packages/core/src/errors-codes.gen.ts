// GENERATED FROM conformance-runner/corpus/contract/error-codes.json @ 0cc33b0ecc750acbe4929408d00542db9d555d2a — DO NOT EDIT
...
export const ERROR_CODES_GENERATED_FROM =
  "0cc33b0ecc750acbe4929408d00542db9d555d2a";
...
export const EXCEPTION_CLASS_PARENTS: ReadonlyMap<string, string | null> =
  new Map([
    ["APIError", "MixpanelHeadlessError"],
    ["AccountExistsError", "ConfigError"],
    ["AccountInUseError", "ConfigError"],
    ["AccountNotFoundError", "ConfigError"],
    ["AuthenticationError", "APIError"],
    ["BookmarkValidationError", "MixpanelHeadlessError"],
    ["BusinessContextValidationError", "MixpanelHeadlessError"],
    ["ConfigError", "MixpanelHeadlessError"],
    ["DateRangeTooLargeError", "MixpanelHeadlessError"],
    ["EventNotFoundError", "MixpanelHeadlessError"],
    ["InvalidArgumentError", "ConfigError"],
    ["MixpanelHeadlessError", null],
    ["OAuthError", "MixpanelHeadlessError"],
    ["ParamTypeError", "MixpanelHeadlessError"],
    ["ParamValidationError", "MixpanelHeadlessError"],
    ["ProjectNotFoundError", "ConfigError"],
    ["QueryError", "APIError"],
