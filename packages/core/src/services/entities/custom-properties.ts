...
export interface CustomPropertyMethods {
  /**
   * List custom properties (`list_custom_properties` — GET
   * `custom_properties/`).
   *
  ...
  /**
   * Create a custom property (`create_custom_property` — POST
   * `custom_properties/`).
   *
  ...
  /**
   * Get a custom property (`get_custom_property` — GET
  ...
  /**
   * Replace a custom property (`update_custom_property` — PUT
   * `custom_properties/{id}/`, full replacement).
   *
   * @param propertyId - Custom-property ID (string).
  ...
  /**
   * Validate a custom-property expression (`validate_custom_property` — POST
