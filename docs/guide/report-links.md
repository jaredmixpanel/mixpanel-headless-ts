...
[`ReportLink`](/reference/core/classes/ReportLink) carries `url`, `slug`, `report_type`, `project_id`, `workspace_id`, `name`, `description`, `bookmark_id`, and `created_at`. `String(link)` is the URL, and `link.toDict()` is the JSON-serializable field set.
...
[`ResolvedReport`](/reference/core/classes/ResolvedReport) carries `source` (`"slug"` or `"bookmark"`), `report_type`, `params`, `project_id`, `workspace_id`, `region`, `url`, `input`, `expanded_url` (the shortlink target), `slug`, `bookmark_id`, `bookmark`, `name`, `description`, and `overrides`. Stored overrides are surfaced as data; they are never merged into `params`.
...
`queryReportLink` dispatches on the report type to `query`, `queryFunnel`, `queryRetention`, or `queryFlow` and returns the matching typed result — [`ReportLinkQueryResult`](/reference/core/type-aliases/ReportLinkQueryResult): [`QueryResult`](/reference/core/classes/QueryResult), [`FunnelQueryResult`](/reference/core/classes/FunnelQueryResult), [`RetentionQueryResult`](/reference/core/classes/RetentionQueryResult), [`FlowQueryResult`](/reference/core/classes/FlowQueryResult) (narrow with `instanceof` or by `report_type`):
...
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The link names another project                                           | [`ReportLinkScopeMismatchError`](/reference/core/classes/ReportLinkScopeMismatchError) / `REPORT_LINK_PROJECT_MISMATCH`   | Switch: `await ws.use({ project: "3" })`. The record was not fetched. For a full URL or a bare slug no network call was made; for a shortlink the one redirect GET had to run first.                                                                                                                                                                                                                                       |
| The link host is another region                                          | [`ReportLinkScopeMismatchError`](/reference/core/classes/ReportLinkScopeMismatchError) / `REPORT_LINK_REGION_MISMATCH`    | Use an account for that region: `await ws.use({ account: "NAME" })`. No network call was made, for shortlinks too.                                                                                                                                                                                                                                                                                                         |
| The link names a workspace and your session is pinned to a different one | [`ReportLinkScopeMismatchError`](/reference/core/classes/ReportLinkScopeMismatchError) / `REPORT_LINK_WORKSPACE_MISMATCH` | Switch: `await ws.use({ workspace: 75 })`. Query requests carry the pinned workspace, so a different data view would change the results. An unpinned session accepts any link. `queryReportLink` runs under exactly the scope the report records — the URL `wid`, or the pin at resolve time, or project-wide — and never injects the current pin, so a pin cleared or set after resolve time cannot change the data view. |
| A saved-report link 404s while a workspace is pinned                     | [`ReportLinkNotFoundError`](/reference/core/classes/ReportLinkNotFoundError) / `REPORT_LINK_BOOKMARK_NOT_FOUND`           | The lookup was workspace-scoped, so the report may live in a sibling workspace of the same project. The message names the pinned workspace; switch or unpin and retry.                                                                                                                                                                                                                                                     |
| The hash starts with `~(`                                                | [`UnsupportedReportLinkError`](/reference/core/classes/UnsupportedReportLinkError) / `UNSUPPORTED_LEGACY_HASH`            | Open the link in a browser. The app re-issues a slug on load; copy the new URL.                                                                                                                                                                                                                                                                                                                                            |
| The link is a board                                                      | [`UnsupportedReportLinkError`](/reference/core/classes/UnsupportedReportLinkError) / `UNSUPPORTED_DASHBOARD_LINK`         | `ws.getDashboard(ID)` lists its reports; resolve one report link. A board URL that carries `edited-bookmark=<slug>` resolves that slug.                                                                                                                                                                                                                                                                                    |
| The slug is unknown here                                                 | [`ReportLinkNotFoundError`](/reference/core/classes/ReportLinkNotFoundError) / `REPORT_LINK_SLUG_NOT_FOUND`               | A slug is readable only in the project and region that created it.                                                                                                                                                                                                                                                                                                                                                         |
| The shortlink redirects to another shortlink                             | [`ShortLinkResolutionError`](/reference/core/classes/ShortLinkResolutionError) / `SHORT_LINK_CHAIN`                       | Resolve the target shortlink directly. Headless follows one redirect only.                                                                                                                                                                                                                                                                                                                                                 |
| The shortlink redirects to the login page                                | [`AuthenticationError`](/reference/core/classes/AuthenticationError)                                                      | The credentials cannot see the shortlink.                                                                                                                                                                                                                                                                                                                                                                                  |

Every error in the family extends [`ReportLinkError`](/reference/core/classes/ReportLinkError) and carries the parsed link parts plus a `hint` in `details`:
...
- Reference: [`Workspace.createReportLink()`](/reference/core/classes/Workspace#createreportlink), [`Workspace.resolveReportLink()`](/reference/core/classes/Workspace#resolvereportlink), [`Workspace.queryReportLink()`](/reference/core/classes/Workspace#queryreportlink), [`Workspace.savedReportLink()`](/reference/core/classes/Workspace#savedreportlink); option bags [`WorkspaceCreateReportLinkOptions`](/reference/core/interfaces/WorkspaceCreateReportLinkOptions), [`WorkspaceQueryReportLinkOptions`](/reference/core/interfaces/WorkspaceQueryReportLinkOptions), [`WorkspaceSavedReportLinkOptions`](/reference/core/interfaces/WorkspaceSavedReportLinkOptions); [`ReportLinkParseError`](/reference/core/classes/ReportLinkParseError), [`ParamValidationError`](/reference/core/classes/ParamValidationError)
