#!/usr/bin/env bash
# B3-K3 R10.9 harness runner. Re-runs everything from the recorded seeds.
#
#   bash throwaway/b3-k3/run.sh              # recorded seed sweep
#   bash throwaway/b3-k3/run.sh 4242 600     # one seed / N draws per family
set -euo pipefail
...
for seed in "${SEEDS[@]}"; do
  echo "== seed $seed (>=${N}/family over 4 families) =="
